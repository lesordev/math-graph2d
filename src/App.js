...
function App() {
  ...
  const [currentSettings, setCurrentSettings] = useState(
    createDefaultSettings(settings_prototype)
  );

  const [unAppliedSettings, setUnApliedSettings] = useState(
    createDefaultSettings(settings_prototype)
  );
  ...
  return (
    ...
    >
      ...
      {/* <Settings
        ...
        unAppliedSettings={unAppliedSettings}
        setUnApliedSettings={setUnApliedSettings}
        settings={settings}
        settings_prototype={settings_prototype}
      /> */}
    </div>
  );
}
